...
<body class="bg-gray-900 text-white">
    ...
    <div class="container mx-auto p-6">
        <h1 class="text-3xl font-bold mb-6">Welcome to Esports Home</h1>
        <div class="banner mb-6 p-6 bg-gray-800 rounded">Banner Image Here</div>
        <div class="text-center mb-6">
            <p class="text-xl">Live Stream Here</p>
            <iframe
