...
<html>
<head>
    <title>Spēlētāja Lietotājvārds: {{ $speletajs->lietotajvards }}</title>
...
<div class="container mx-auto p-6">
    <h1 class="text-3xl font-bold mb-6">Spēlētāja Lietotājvārds: {{ $speletajs->lietotajvards }}</h1>
        ...
        <div class="bg-gray-800 p-4 rounded mb-3">
            ...
            @auth
                ...
                <div class="mt-2">
                    ...
                    <form id="reply-form-{{ $comment->id }}" action="{{ route('comment.store', ['type' => 'speletajs', 'id' => $speletajs->SpeletajsID]) }}" method="POST" enctype="multipart/form-data" class="hidden mt-2 bg-gray-800 p-4 rounded">
                        @csrf
    ...
    @auth
        ...
        @endif
        <form action="{{ route('comment.store', ['type' => 'speletajs', 'id' => $speletajs->SpeletajsID]) }}" method="POST" enctype="multipart/form-data" class="bg-gray-800 p-4 rounded mt-6">
            @csrf
            <div class="form-group mb-4">
